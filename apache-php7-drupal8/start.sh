...
sed -i "s|DocumentRoot /var/www/html\$|DocumentRoot $APACHE_DOC_ROOT/web|" /etc/apache2/sites-available/000-default.conf

echo "<Directory $APACHE_DOC_ROOT/web>" > /etc/apache2/conf-available/document-root.conf
